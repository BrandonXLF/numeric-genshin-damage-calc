...
const indicators = {
	...
	/>,
	plus: (props?: SVGProps<SVGPathElement>) => <path
		{...props}
		d="M 11.6 7.2 a 1.1 1.1 0 0 1 1.1 1.1 v 2.2 h 2.2 a 1.1 1.1 0 0 1 0 2.2 h -2.2 v 2.2 a 1.1 1.1 0 0 1 -2.2 0 v -2.2 h -2.2 a 1.1 1.1 0 0 1 0 -2.2 h 2.2 v -2.2 a 1.1 1.1 0 0 1 1.1 -1.1"
	/>
};
